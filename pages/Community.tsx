    ...
    <div className="pt-40 pb-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-32">
          <img src="/2655920151.jpeg" className="w-full h-80 object-cover rounded-2xl" alt="Classroom work" />
          <img src="/2257172535.jpeg" className="w-full h-80 object-cover rounded-2xl md:translate-y-12" alt="Children working" />
          <img src="/1618644940.jpeg" className="w-full h-80 object-cover rounded-2xl" alt="Outdoor play" />
          <img src="/1654071166.jpeg" className="w-full h-80 object-cover rounded-2xl md:translate-y-12" alt="Community events" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-32">
          <div className="rounded-3xl overflow-hidden shadow-2xl aspect-[4/5]">
            <img src="/2033374133.jpeg" alt="Active community life" className="w-full h-full object-cover" />
          </div>
